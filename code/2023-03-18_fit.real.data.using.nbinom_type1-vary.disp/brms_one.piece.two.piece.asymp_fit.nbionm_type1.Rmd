...
save_plots_file <- FALSE  ## Save plots to file?
## save_plots_tibble
##rerender_plots <- FALSE ## Option to force rerendering of plot
run_fits <- FALSE
save_fits <- TRUE #FALSE
run_fits_force <- FALSE # force refitting of model; used with run_fits = TRUE
force_load <- FALSE  # reload fit_tbl even if it already exits; used with run_fits = FALSE
        ...
        for(y0_flag in flags_y0_used) {
          ...
          for(disp_value in values_disp_used) {
            ...
            if(run_fits) {
              ...
              if(!exists("fit_tbl") | force_load | nrow(fit_tbl) == 0) {
