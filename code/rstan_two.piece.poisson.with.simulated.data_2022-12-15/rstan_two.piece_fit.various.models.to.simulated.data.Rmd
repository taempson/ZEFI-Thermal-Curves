---
title: "Piecewise Regression on Simulated NB data and Observed Data using STAN Directly"
...
model <- stan(file = "two.piece_qpoisson.grouped.by.male.stan",
              model_name = "Two piece nb pooled",
              data=list(x = temp,
                        y = motif_count,
                        N = N,
                        L = 1,
