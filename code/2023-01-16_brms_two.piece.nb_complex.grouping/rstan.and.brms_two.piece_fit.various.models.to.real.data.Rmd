---
<<<<<<<< HEAD:code/2023-01-12_brms_generate.and.fit.realistic.simulated.data/brms_two.piece_create.and.fit.simulated.data.Rmd
...
>>>>>>>> restore.real.data.fit:code/2023-01-16_brms_two.piece.nb_complex.grouping/rstan.and.brms_two.piece_fit.various.models.to.real.data.Rmd
...
nlform <- bf(y ~  0 - (xmax - fmax(x0, x)) * (0 - y0)/(46 - x0),
             x_form,
             y_form,
             nl = TRUE)
