...
flags_x <- c("individual", "uniform_1", "groups_1")
...
## Run Analysis
fit_save_to_tbl <- function(x_flag = "uniform_1",
                            y_flag="uniform_1",
                            sampling_dist = "nb",
                            data,
                            priors) { 
  ...
  x0_group_list <- list(unique(data[, c("male", "x0_group")]))
  x0_group_list <- list(unique(data[, c("male", "x0_group")]))
  ...
  family <- switch(sampling_dist,
                   ...
                   "com_poisson"=com_poisson(link="identity", link_shape="log")
                   )
  ...
  save_model <-paste0(paste("brms", sampling_dist, x_flag, y_flag, sep="_"), ".stan")
