...
models_used <- c("two_piece") #, "asymptotic") #c("one_piece", "two_piece") #, "two_piece")
            ...
            if(run_fits) {
              ...
              y0_priors <- switch(y0_flag,
                                  ...
                                  individual = switch(1,
                                                      ...
                                                      prior(uniform(10, 1000), nlpar = "y0", lb = 10, ub = 1000) # flat prior (10,500) and (10, 1000) lead to sampling issues with T235 and 236
                                                      ),
                                  other = NULL
                                  )
              ...
              disp_priors <- switch(disp_flag,
                                    ...
                                    groups_1 = set_prior(prior_string,
                                                         class = "Intercept", dpar = "disp", lb = 0, ub = 20),
                                    groups_2a = NULL,
                                    groups_2b = NULL,
