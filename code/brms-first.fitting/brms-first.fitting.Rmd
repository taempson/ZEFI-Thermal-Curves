...
#nlprior <- c(prior(Gamma(shape = 10, scale = 10 ), nlpar = "rmax"),
#          prior(normal(35, 100), nlpar = "topt"),
#          prior(Gamma(shape = 1, scale = 100), nlpar = "a"),
#          prior(normal(0, 5), nlpar = "b"))
        
nlprior <- c(prior(normal(200, 100 ), nlpar = "rmax"),
          prior(normal(35, 100), nlpar = "topt"),
          prior(normal( 1, 100), nlpar = "a"),
          prior(normal(0, 5), nlpar = "b"))          

fit_mgauss1 <- brm(formula = nlform,
                   data = data,
