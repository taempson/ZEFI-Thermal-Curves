...
for(t1max in c(46, 45)) {
    ...
    print(main)
    print(fit_2)
    traceplot(fit_2, pars = c("t1", "b1", "lp__"), inc_warmup = FALSE, main = main)
    plot(fit_2, pars = c("t1", "b1", "lp__"), main = main)
    pairs(fit_2, pars = c("t1", "b1", "lp__"), main = main)
}
